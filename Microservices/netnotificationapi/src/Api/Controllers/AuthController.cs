...
namespace Api.Controllers
{
    ...
    public class AuthController : ApiControllerBase
    {
        ...
        public async Task<IEnumerable<WeatherForecast>> UserAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");

            _logger.LogInformation("UserAccess: Weather Forecast called!");
        ...
        [Authorize]
        public async Task<IEnumerable<WeatherForecast>> PowerUserAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");
            if (User.IsInRole("PowerUser"))
            {
                _logger.LogInformation("PowerUserAccess: Weather Forecast called!");
            }
        ...
        [Authorize]
        public async Task<IEnumerable<WeatherForecast>> AdminAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");
            if (User.IsInRole("Admin"))
            {
                _logger.LogInformation("AdminAccess: Weather Forecast called!");
            }
        ...
        [HttpGet("SystemManagerAccess")]
        //[Authorize(Roles = "SystemManager")]
        [Authorize]
        public IEnumerable<WeatherForecast> SystemManagerAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");

            if (User.IsInRole("SystemManager"))
            {
                _logger.LogInformation("SystemManagerAccess: Weather Forecast called!");
            }
        ...
        [HttpGet("MarketingManagerAccess")]
        //[Authorize(Roles = "MarketingManager")]
        [Authorize]
        public IEnumerable<WeatherForecast> MarketingManagerAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");

            if (User.IsInRole("MarketingManager"))
            {
                _logger.LogInformation("MarketingManagerAccess: Weather Forecast called!");
            }
        ...
        [HttpGet("SalesDirectorAccess")]
        //[Authorize(Roles = "SalesDirector")]
        [Authorize]
        public IEnumerable<WeatherForecast> SalesDirectorAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");

            if (User.IsInRole("SalesDirectorAccess"))
            {
                _logger.LogInformation("SalesDirectorAccess: Weather Forecast called!");
            }
        ...
        [HttpGet("AccountManagerAccess")]
        //[Authorize(Roles = "AccountManager")]
        [Authorize]
        public IEnumerable<WeatherForecast> AccountManagerAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");
            ...
            {
                _logger.LogInformation("AccountManagerAccess: Weather Forecast called!");
            }
        ...
        [HttpGet("ClientExecutiveAccess")]
        //[Authorize(Roles = "ClientExecutive")]
        [Authorize]
        public IEnumerable<WeatherForecast> ClientExecutiveAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");
            if (User.IsInRole("ClientExecutive"))
            {
                _logger.LogInformation("ClientExecutiveAccess: Weather Forecast called!");
            }
        ...
        [HttpGet("SeniorClientExecutiveAccess")]
        //[Authorize(Roles = "SeniorClientExecutive")]
        [Authorize]
        public IEnumerable<WeatherForecast> SeniorClientExecutiveAccess()
        {
            // HttpContext.VerifyUserHasAnyAcceptedScope("access_as_user");
            // HttpContext.ValidateAppRole("access_as_application");
            if (User.IsInRole("SeniorClientExecutive"))
            {
                _logger.LogInformation("SeniorClientExecutiveAccess: Weather Forecast called!");
            }
