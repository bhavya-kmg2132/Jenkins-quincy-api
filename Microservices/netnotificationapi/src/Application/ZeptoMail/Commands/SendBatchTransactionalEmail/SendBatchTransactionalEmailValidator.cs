...
{
    public class SendBatchTransactionalEmailValidator : AbstractValidator<SendBatchTransactionalEmailRequest>
    {
        private readonly ILogger _logger;
        private readonly IConfiguration _configuration;

        public SendBatchTransactionalEmailValidator(IConfiguration configuration, ILogger logger)
        {
