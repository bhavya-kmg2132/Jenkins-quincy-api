...
{
    /// <summary>
    /// For Creating handler for the domain event notification, created NotificationCreatedEventHandler 
    ...
    public class NotificationCreatedEventHandler : INotificationHandler<DomainEventNotification<NotificationCreatedEvent>>
    {
        ...
        /// <summary>
        /// Instantiation of NotificationCreatedEventHandler class
        /// </summary>
        /// <param name="configuration"></param>
        /// <param name="logger"></param>
        public NotificationCreatedEventHandler(IConfiguration configuration, ILogger<NotificationCreatedEventHandler> logger)
        {
        ...
        public System.Threading.Tasks.Task Handle(DomainEventNotification<NotificationCreatedEvent> notification, CancellationToken cancellationToken)
        {
        ...
        private async void ProduceKafkaEvent(NotificationCreatedEvent domainEvent)
        {
            //KAFKA
        ...
        private async void ProduceKafkaEvent_topic_elastic_search(NotificationCreatedEvent domainEvent)
        {
        ...
        private PublishEventData PrepareEventDataFor_topic_elastic_search(NotificationCreatedEvent domainEvent)
        {
