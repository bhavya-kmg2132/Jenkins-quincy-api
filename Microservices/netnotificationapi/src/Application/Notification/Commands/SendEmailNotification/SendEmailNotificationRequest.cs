...
{
    public class SendEmailNotificationRequest : IRequest<string>
    {
    ...
    /// <summary>
    /// For Creating handler for the above request, created SendEmailNotificationRequestHandler class
    ///that implements the IRequestHandler interface as shown below.
    /// </summary>
    public class SendEmailNotificationRequestHandler : IRequestHandler<SendEmailNotificationRequest, string>
    {
        ...
        /// <summary>
        /// Instantiates the SendEmailNotificationRequestHandler class
        /// </summary>
        ...
        public SendEmailNotificationRequestHandler(ILogger logger, IConfiguration configuration, IMapper mapper, IEmailNotificationService emailService, IWebHostEnvironment environment)
        {
            this._logger = logger;
        ...
        public async Task<string> Handle(SendEmailNotificationRequest query, CancellationToken cancellationToken)
        {

            //1. Logging Information - In process
            _logger.LogInformation("SendEmailNotificationRequest.Handle - In process");
            ...
            var notificationResponse = await _EmailService.SendEmailNotification(entity);
            ...
            _logger.LogInformation("SendEmailNotificationRequest.Handle - Completed");
