...
{
    public class SendBatchEmailUsingMicrosoftGraphRequestValidator : AbstractValidator<SendBatchEmailUsingMicrosoftGraphRequest>
    {
        private readonly ILogger _logger;
        private readonly IConfiguration _configuration;

        public SendBatchEmailUsingMicrosoftGraphRequestValidator(IConfiguration configuration, ILogger logger)
        {
