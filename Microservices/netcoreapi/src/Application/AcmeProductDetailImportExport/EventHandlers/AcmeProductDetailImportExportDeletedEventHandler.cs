...
//        public AcmeProductDeletedEventHandler(IConfiguration configuration, ILogger<AcmeProductDeletedEventHandler> logger)
//        {
...
//        public Task Handle(DomainEventNotification<AcmeProductDeletedEvent> notification, CancellationToken cancellationToken)
//        {
...
//        private async void ProduceKafkaEvent(AcmeProductDeletedEvent domainEvent)
//        {
//            //KAFKA
...
//            domainEvent.AcmeDeletedObject.AuditableSourceEventName = nameof(AcmeProductDeletedEvent);
...
//        private async void ProduceKafkaEvent_topic_elastic_search(AcmeProductDeletedEvent domainEvent)
//        {
...
//            //Serialize object to send to KAFKA TOPIC
//            domainEvent.AcmeDeletedObject.AuditableSourceEventName = nameof(AcmeProductCreatedEvent);
...
//        private PublishEventData PrepareEventDataFor_topic_elastic_search(AcmeProductDeletedEvent domainEvent)
//        {
...
//            eventData.EventName = newObject.AuditableSourceEventName;
//            eventData.OperationType = OperationType.DELETE;
...
//                    NewValue = item.GetValue(newObject, null),
//                });
//            }
//            //returns eventData
//            return eventData;
