...
//        public AcmeProductUpdatedEventHandler(IConfiguration configuration, ILogger<AcmeProductUpdatedEventHandler> logger)
//        {
...
//        public Task Handle(DomainEventNotification<AcmeProductUpdatedEvent> notification, CancellationToken cancellationToken)
//        {
...
//        private async void ProduceKafkaEvent(AcmeProductUpdatedEvent domainEvent)
//        {
//            //KAFKA
...
//            domainEvent.AcmeNewObject.AuditableSourceEventName = nameof(AcmeProductUpdatedEvent);
...
//        private async void ProduceKafkaEvent_topic_elastic_search(AcmeProductUpdatedEvent domainEvent)
//        {
...
//        private PublishEventData PrepareEventDataFor_topic_elastic_search(AcmeProductUpdatedEvent domainEvent)
//        {
...
//            eventData.OperationType = OperationType.UPDATE;
...
//                    OldValue = item.GetValue(oldObject, null)
//                });
//            }
//            //returns eventData
//            return eventData;
