...
{
    public class CancelPolicyValidator : AbstractValidator<CancelPolicyRequest>
    {
        public CancelPolicyValidator()
        {
            RuleFor(x => x.PolicyNumber)
                .NotEmpty()
                .WithMessage(Resources.ErrorMessages.CancelPolicyValidator_PolicyNumber_NotEmpty);

            RuleFor(x => x.WinsTransactionCode)
                .NotEmpty()
                .WithMessage(Resources.ErrorMessages.CancelPolicyValidator_WinsTransactionCode_NotEmpty);

            RuleFor(x => x.EffectiveDate)
                .NotEmpty()
                .WithMessage(Resources.ErrorMessages.CancelPolicyValidator_EffectiveDate_NotEmpty);

            RuleFor(x => x.CancelDate)
                .NotEmpty()
                .WithMessage(Resources.ErrorMessages.CancelPolicyValidator_CancelDate_NotEmpty);
            ...
            RuleFor(x => x.CancelDate)
                ...
                .WithMessage(Resources.ErrorMessages.CancelPolicyValidator_CancelDate_BeforeEffectiveDate)
