...
{
    /// <summary>
    /// For Creating handler for the domain event notification,Deleted AcmeProductDeletedEventHandler 
    /// class that implements the INotificationHandler interface as shown below.
    /// </summary>
    public class AcmeProductDeletedEventHandler : INotificationHandler<DomainEventNotification<AcmeProductDeletedEvent>>
    {
        private readonly ILogger<AcmeProductDeletedEventHandler> _logger;
        ...
        /// <summary>
        ///  Instantiation of AcmeProductDeletedEventHandler class
        /// </summary>
        /// <param name="logger"></param>
        public AcmeProductDeletedEventHandler(IConfiguration configuration, ILogger<AcmeProductDeletedEventHandler> logger, IPublishEventDataAccess publishEventDataAccess, IUserDataAccess userDataAccess, IMassTransitPublisher massTransitPublisher, ICurrentUserService currentUserService, NotificationHelper notificationHelper)
        {
        ...
        public async Task Handle(DomainEventNotification<AcmeProductDeletedEvent> notification, CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        private async Task ProduceEvent(AcmeProductDeletedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private async Task ProduceMassTransitEvent(AcmeProductDeletedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task PublishEventForNotification(AcmeProductDeletedEvent domainEvent)
        {
        ...
        public NotificationData NotificationDataMapping(AcmeProductDeletedEvent domainEvent)
        {
            return new NotificationData
            {
                EventType = nameof(AcmeProductDeletedEvent),
                Subject = "Acme Product Deleted!",
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task<Domain.Entities.ZeptoMail> PrepareDataFor_notification(AcmeProductDeletedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <param name="domainEvent"></param>
        private async void AddEventInEventStore_EventDB(AcmeProductDeletedEvent domainEvent)
        {
            try
            {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private PublishEventData PrepareEventDataForAuditLog(AcmeProductDeletedEvent domainEvent)
        {
            //prepare event data for Audit Log
            var newObject = domainEvent.AcmeDeletedObject;
            ...
            eventData.CorrelationId = domainEvent.AcmeDeletedObject.CorrelationId;
            eventData.AuditableRequestId = domainEvent.AcmeDeletedObject.AuditableRequestId;
            eventData.AuditableRequestName = domainEvent.AcmeDeletedObject.AuditableRequestName;
