...
namespace Application.AcmeProduct.EventHandlers
{
    ...
    public class AcmeProductCompletedEventHandler : INotificationHandler<DomainEventNotification<AcmeProductCompletedEvent>>
    {
        ...
        public AcmeProductCompletedEventHandler(IConfiguration configuration, ILogger<AcmeProductCompletedEventHandler> logger, IPublishEventDataAccess publishEventDataAccess, IMassTransitPublisher massTransitPublisher, IUserDataAccess userDataAccess, ICurrentUserService currentUserService, NotificationHelper notificationHelper)
        {
        ...
        public async Task Handle(DomainEventNotification<AcmeProductCompletedEvent> notification, CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        private async Task ProduceEvent(AcmeProductCompletedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private async Task ProduceMassTransitEvent(AcmeProductCompletedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task PublishEventForNotification(AcmeProductCompletedEvent domainEvent)
        {
        ...
        public NotificationData NotificationDataMapping(AcmeProductCompletedEvent domainEvent)
        {
            return new NotificationData
            {
                EventType = nameof(AcmeProductCompletedEvent),
                Subject = "",
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task<Domain.Entities.ZeptoMail> PrepareDataFor_notification(AcmeProductCompletedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <param name="domainEvent"></param>
        private async void AddEventInEventStore_EventDB(AcmeProductCompletedEvent domainEvent)
        {
            try
            {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private PublishEventData PrepareEventDataForAuditLog(AcmeProductCompletedEvent domainEvent)
        {
            //prepare event data for Audit Log
            var newObject = domainEvent.AcmeCompletedObject;
            ...
            eventData.CorrelationId = domainEvent.AcmeCompletedObject.CorrelationId;
            eventData.AuditableRequestId = domainEvent.AcmeCompletedObject.AuditableRequestId;
            eventData.AuditableRequestName = domainEvent.AcmeCompletedObject.AuditableRequestName;
            eventData.AuditableAssemblyQualifiedName = $"ApiDesign10_netcore_{Assembly.GetExecutingAssembly().GetName().Name}";
            eventData.AuditableSourceEventName = nameof(AcmeProductCompletedEvent);
            #endregion
