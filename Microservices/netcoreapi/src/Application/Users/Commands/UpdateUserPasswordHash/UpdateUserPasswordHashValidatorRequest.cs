...
{
    public class UpdateUserPasswordHashValidatorRequest : AbstractValidator<UpdateUserPasswordHashRequest>
    {
        /// <summary>
        /// Validates User PasswordHash request
        /// </summary>
        public UpdateUserPasswordHashValidatorRequest()
        {
            //1) Id
            //It is mandatory.
            //RuleFor(x => x.Id).Cascade(CascadeMode.Stop)
            //   .NotEmpty()
            //   .WithMessage(Resources.ErrorMessages.UpdateUserRequestValidator_Id_NotEmpty);

            //2) oid
            //It is mandatory.
            //RuleFor(x => x.oid).Cascade(CascadeMode.Stop)
            //  .NotEmpty()
            //  .WithMessage(Resources.ErrorMessages.UpdateUserRequestValidator_oid_NotEmpty);

            ////3) dipslay_name
            ////It is mandatory.
            //RuleFor(x => x.display_name).Cascade(CascadeMode.Stop)
            //   .NotEmpty()
            //   .WithMessage(Resources.ErrorMessages.UpdateUserRequestValidator_display_name_NotEmpty);
            ...
            //   .NotEmpty()
            //   .WithMessage(Resources.ErrorMessages.UpdateUserRequestValidator_Email_NotEmpty)
