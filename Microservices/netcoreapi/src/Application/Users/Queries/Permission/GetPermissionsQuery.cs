...
namespace Application.Users.Queries.Permission.GetPermissionsQuery
{
    /// <summary>
    /// class GetPermissionQueryHandler extends the IRequest interface of MediatR
    /// </summary>
    public class GetPermissionsQuery : IRequest<PermissionListVm>
    {
    ...
    /// </summary>
    public class GetPermissionsQueryHandler : IRequestHandler<GetPermissionsQuery, PermissionListVm>
    {
        ...
        public GetPermissionsQueryHandler(IConfiguration configuration, ILogger logger, IMapper mapper, IIdentityManager dataAccess)
        {
        ...
        /// <returns></returns>
        public async Task<PermissionListVm> Handle(GetPermissionsQuery request, CancellationToken cancellationToken)
        {
