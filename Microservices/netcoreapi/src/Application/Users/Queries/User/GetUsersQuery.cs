...
namespace Application.AllUsers.Queries.AllUser.GetUsersQuery
{
    /// <summary>
    ...
    public class GetUsersQueryHandler : IRequestHandler<GetUsersQuery, UserListVm>
    {
        ...
        public GetUsersQueryHandler(IConfiguration configuration, ILogger logger, IMapper mapper, IIdentityManager dataAccess)
        {
        ...
        public async Task<UserListVm> Handle(GetUsersQuery request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation("GetUsersQuery - In process");
