...
{
    /// <summary>
    /// For Creating handler for the domain event notification,created UserCompletedEventHandler 
    ...
    public class UserCompletedEventHandler : INotificationHandler<DomainEventNotification<UserCompletedEvent>>
    {
        ...
        /// <summary>
        /// Instantiation of UserCompletedEventHandler class
        /// </summary>
        /// <param name="logger"></param>
        public UserCompletedEventHandler(IConfiguration configuration, ILogger<UserCompletedEventHandler> logger, IPublishEventDataAccess publishEventDataAccess)
        {
        ...
        public Task Handle(DomainEventNotification<UserCompletedEvent> notification, CancellationToken cancellationToken)
        {
            ...
            domainEvent.UsersDetails.AuditableSourceEventName = nameof(UserCompletedEvent);
        ...
        private async void AddEventDataForAuditLog(UserCompletedEvent domainEvent)
        {
            try
            {
        ...
        private PublishEventData PrepareEventDataForAuditLog(UserCompletedEvent domainEvent)
        {
            //prepare event data for Audit Log
