...
{
    /// <summary>
    /// For Creating handler for the domain event notification,Deleted PolicyDeletedEventHandler
    /// class that implements the INotificationHandler interface as shown below.
    /// </summary>
    public class PolicyDeletedEventHandler : INotificationHandler<DomainEventNotification<PolicyDeletedEvent>>
    {
        private readonly ILogger<PolicyDeletedEventHandler> _logger;
        ...
        /// <summary>
        /// Instantiation of PolicyDeletedEventHandler class
        /// </summary>
        /// <param name="logger"></param>
        public PolicyDeletedEventHandler(IConfiguration configuration, ILogger<PolicyDeletedEventHandler> logger, IPublishEventDataAccess publishEventDataAccess, IMassTransitPublisher massTransitPublisher, IUserDataAccess userDataAccess, ICurrentUserService currentUserService, NotificationHelper notificationHelper)
        {
        ...
        public async Task Handle(DomainEventNotification<PolicyDeletedEvent> notification, CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        private async Task ProduceEvent(PolicyDeletedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private async Task ProduceMassTransitEvent(PolicyDeletedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task PublishEventForNotification(PolicyDeletedEvent domainEvent)
        {
        ...
        public NotificationData NotificationDataMapping(PolicyDeletedEvent domainEvent)
        {
            var policy = domainEvent.PolicyDeletedObject;
            return new NotificationData
            {
                EventType = nameof(PolicyDeletedEvent),
                Subject = $"Policy Deleted: {policy.PolicyNumber} - {policy.PolicyName}",
                ToEmails = new Dictionary<string, string>
                {
                    [_currentUserService.display_name ?? "Test user"] = _currentUserService.Email
                },
                htmlTemplate = $"<!DOCTYPE html>\r\n<html>\r\n<head>\r\n  <meta charset=\"UTF-8\">\r\n  <title>Policy Deleted</title>\r\n</head>\r\n<body style=\"margin:0;padding:0;font-family:Arial,sans-serif;background-color:#f4f6f8;\">\r\n<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color:#f4f6f8;padding:20px;\">\r\n  <tr><td align=\"center\">\r\n    <table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"background:#ffffff;border-radius:8px;overflow:hidden;\">\r\n      <tr><td style=\"background:#C62828;color:#ffffff;padding:20px;text-align:center;\">\r\n        <h2 style=\"margin:0;\">Policy Deleted</h2>\r\n      </td></tr>\r\n      <tr><td style=\"padding:30px;color:#333;\">\r\n        <h3 style=\"margin-top:0;\">Policy Has Been Deleted</h3>\r\n        <p>Hello <strong>{_currentUserService.display_name}</strong>,</p>\r\n        <p>The following policy has been deleted from the system:</p>\r\n        <table width=\"100%\" cellpadding=\"8\" cellspacing=\"0\" style=\"margin:20px 0;border-collapse:collapse;\">\r\n          <tr style=\"background:#f1f1f1;\"><td><strong>Policy Number</strong></td><td>{policy.PolicyNumber}</td></tr>\r\n          <tr><td><strong>Policy Name</strong></td><td>{policy.PolicyName}</td></tr>\r\n          <tr style=\"background:#f1f1f1;\"><td><strong>Policy Type</strong></td><td>{policy.PolicyType}</td></tr>\r\n          <tr><td><strong>Status</strong></td><td>{policy.StatusCode}</td></tr>\r\n          <tr style=\"background:#f1f1f1;\"><td><strong>Insured Name</strong></td><td>{policy.InsuredName}</td></tr>\r\n          <tr><td><strong>Effective Date</strong></td><td>{policy.EffectiveDate:yyyy-MM-dd}</td></tr>\r\n          <tr style=\"background:#f1f1f1;\"><td><strong>Expiration Date</strong></td><td>{policy.ExpirationDate:yyyy-MM-dd}</td></tr>\r\n          <tr><td><strong>Producer</strong></td><td>{policy.ProducerName}</td></tr>\r\n        </table>\r\n        <p>If this deletion was unintended, please contact your system administrator immediately.</p>\r\n        <p>Regards,<br><strong>Quincy Policy System</strong></p>\r\n      </td></tr>\r\n      <tr><td style=\"background:#f1f1f1;text-align:center;padding:15px;font-size:12px;color:#777;\">\r\n        &copy; 2026 KMG Inc. All rights reserved.\r\n      </td></tr>\r\n    </table>\r\n  </td></tr>\r\n</table>\r\n</body>\r\n</html>"
            };
        }
        ...
        /// </summary>
        /// <param name="domainEvent"></param>
        private async void AddEventInEventStore_EventDB(PolicyDeletedEvent domainEvent)
        {
            try
            {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private PublishEventData PrepareEventDataForAuditLog(PolicyDeletedEvent domainEvent)
        {
            //prepare event data for Audit Log
            var newObject = domainEvent.PolicyDeletedObject;
            ...
            eventData.CorrelationId = domainEvent.PolicyDeletedObject.CorrelationId;
            eventData.AuditableRequestId = domainEvent.PolicyDeletedObject.AuditableRequestId;
            eventData.AuditableRequestName = domainEvent.PolicyDeletedObject.AuditableRequestName;
            eventData.AuditableAssemblyQualifiedName = $"ApiDesign10_netcore_{Assembly.GetExecutingAssembly().GetName().Name}";
            eventData.AuditableSourceEventName = nameof(PolicyDeletedEvent);
            #endregion
