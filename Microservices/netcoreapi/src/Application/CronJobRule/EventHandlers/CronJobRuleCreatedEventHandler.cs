...
{
    /// <summary>
    /// For Creating handler for the domain event notification,created CronJobRuleCreatedEventHandler 
    /// class that implements the INotificationHandler interface as shown below.
    /// </summary>
    public class CronJobRuleCreatedEventHandler : INotificationHandler<DomainEventNotification<CronJobRuleCreatedEvent>>
    {
        private readonly ILogger<CronJobRuleCreatedEventHandler> _logger;
        ...
        /// <summary>
        /// Instantiation of CronJobRuleCreatedEventHandler class
        /// </summary>
        /// <param name="logger"></param>
        /// <param name="configuration"></param>
        public CronJobRuleCreatedEventHandler(IConfiguration configuration, ILogger<CronJobRuleCreatedEventHandler> logger, IPublishEventDataAccess publishEventDataAccess, IUserDataAccess userDataAccess, IMassTransitPublisher massTransitPublisher)
        {
        ...
        public async Task Handle(DomainEventNotification<CronJobRuleCreatedEvent> notification, CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        private async Task ProduceEvent(CronJobRuleCreatedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private async Task ProduceMassTransitEvent(CronJobRuleCreatedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task PublishEventForNotification(CronJobRuleCreatedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task<Domain.Entities.ZeptoMail> PrepareDataFor_notification(CronJobRuleCreatedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <param name="domainEvent"></param>
        private async void AddEventInEventStore_EventDB(CronJobRuleCreatedEvent domainEvent)
        {
            try
            {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private PublishEventData PrepareEventDataForAuditLog(CronJobRuleCreatedEvent domainEvent)
        {
            //prepare event data for Audit Log
            var newObject = domainEvent.CronJobRuleCreatedObject;
            ...
            eventData.CorrelationId = domainEvent.CronJobRuleCreatedObject.CorrelationId;
            eventData.AuditableRequestId = domainEvent.CronJobRuleCreatedObject.AuditableRequestId;
            eventData.AuditableRequestName = domainEvent.CronJobRuleCreatedObject.AuditableRequestName;
            eventData.AuditableAssemblyQualifiedName = $"ApiDesign10_netcore_{Assembly.GetExecutingAssembly().GetName().Name}";
            eventData.AuditableSourceEventName = nameof(CronJobRuleCreatedEvent);
            #endregion
