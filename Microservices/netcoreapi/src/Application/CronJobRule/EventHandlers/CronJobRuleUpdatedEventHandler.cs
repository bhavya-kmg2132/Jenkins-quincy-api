...
{
    /// <summary>
    /// For Creating handler for the domain event notification,Updated CronJobRuleUpdatedEventHandler 
    /// class that implements the INotificationHandler interface as shown below.
    /// </summary>
    public class CronJobRuleUpdatedEventHandler : INotificationHandler<DomainEventNotification<CronJobRuleUpdatedEvent>>
    {
        private readonly ILogger<CronJobRuleUpdatedEventHandler> _logger;
        ...
        /// <summary>
        ///  Instantiation of CronJobRuleUpdatedEventHandler class
        /// </summary>
        /// <param name="configuration"></param>
        /// <param name="logger"></param>
        public CronJobRuleUpdatedEventHandler(IConfiguration configuration, ILogger<CronJobRuleUpdatedEventHandler> logger, IPublishEventDataAccess publishEventDataAccess, IMassTransitPublisher massTransitPublisher, IUserDataAccess userDataAccess)
        {
        ...
        public async Task Handle(DomainEventNotification<CronJobRuleUpdatedEvent> notification, CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        private async Task ProduceEvent(CronJobRuleUpdatedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private async Task ProduceMassTransitEvent(CronJobRuleUpdatedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task PublishEventForNotification(CronJobRuleUpdatedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task<Domain.Entities.ZeptoMail> PrepareDataFor_notification(CronJobRuleUpdatedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <param name="domainEvent"></param>
        private async void AddEventInEventStore_EventDB(CronJobRuleUpdatedEvent domainEvent)
        {
            try
            {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private PublishEventData PrepareEventDataForAuditLog(CronJobRuleUpdatedEvent domainEvent)
        {
            //prepare event data for Audit Log
            var newObject = domainEvent.CronJobRuleNewObject;
            var oldObject = domainEvent.CronJobRuleOldObject;
