...
{
    /// <summary>
    /// For Creating handler for the domain event notification,created CronJobRuleCompletedEventHandler 
    /// class that implements the INotificationHandler interface as shown below.
    /// </summary>
    public class CronJobRuleCompletedEventHandler : INotificationHandler<DomainEventNotification<CronJobRuleCompletedEvent>>
    {
        private readonly ILogger<CronJobRuleCompletedEventHandler> _logger;
        ...
        /// <summary>
        /// Instantiation of CronJobRuleCompletedEventHandler class
        /// </summary>
        /// <param name="logger"></param>
        public CronJobRuleCompletedEventHandler(IConfiguration configuration, ILogger<CronJobRuleCompletedEventHandler> logger, IPublishEventDataAccess publishEventDataAccess, IMassTransitPublisher massTransitPublisher, IUserDataAccess userDataAccess)
        {
        ...
        public async Task Handle(DomainEventNotification<CronJobRuleCompletedEvent> notification, CancellationToken cancellationToken)
        {
            ...
            // No notification needed for Completed Event
        ...
        /// <returns></returns>
        private async Task ProduceEvent(CronJobRuleCompletedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private async Task ProduceMassTransitEvent(CronJobRuleCompletedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task PublishEventForNotification(CronJobRuleCompletedEvent domainEvent)
        {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private async Task<Domain.Entities.ZeptoMail> PrepareDataFor_notification(CronJobRuleCompletedEvent domainEvent)
        {
        ...
        /// </summary>
        /// <param name="domainEvent"></param>
        private async void AddEventInEventStore_EventDB(CronJobRuleCompletedEvent domainEvent)
        {
            try
            {
        ...
        /// <param name="domainEvent"></param>
        /// <returns></returns>
        private PublishEventData PrepareEventDataForAuditLog(CronJobRuleCompletedEvent domainEvent)
        {
            //prepare event data for Audit Log
            var newObject = domainEvent.CronJobRuleCompletedObject;
            ...
            eventData.CollectionName = "NotificationRule";

            #region Request Tracing
            eventData.CorrelationId = domainEvent.CronJobRuleCompletedObject.CorrelationId;
            eventData.AuditableRequestId = domainEvent.CronJobRuleCompletedObject.AuditableRequestId;
            eventData.AuditableRequestName = domainEvent.CronJobRuleCompletedObject.AuditableRequestName;
            eventData.AuditableAssemblyQualifiedName = $"ApiDesign10_netcore_{Assembly.GetExecutingAssembly().GetName().Name}";
            eventData.AuditableSourceEventName = nameof(CronJobRuleCompletedEvent);
            #endregion
